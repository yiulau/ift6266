...
def main(save_to, num_epochs, feature_maps=None, 
         ...
         from_server=False,num_batches=None,image_size=64):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch-size", type=int, default=64,
                    help="Batch size.")
    parser.add_argument("--from-server",type=bool,default=False,
                    help="Are we getting the data")
